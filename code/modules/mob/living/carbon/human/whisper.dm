...
/mob/living/carbon/human/proc/whisper_say(var/message, var/datum/language/speaking = null, var/alt_name="", var/verb="whispers")
	...
	if(voice_sub == "Unknown")
		if(copytext_char(message, 1, 2) != "*")
			...
			message = replacetext_char(message, "o", "¤")
			message = replacetext_char(message, "p", "ž")
			message = replacetext_char(message, "l", "£")
			message = replacetext_char(message, "s", "§")
			message = replacetext_char(message, "u", "µ")
			message = replacetext_char(message, "b", "ß")
